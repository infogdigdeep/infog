...
import com.infog.common.service.UserService;
...
public class UserController {
	...
	public @ResponseBody GenericListDto<User> getUsers() {
		
		GenericListDto<User> userListDto = new GenericListDto<User>();
		userListDto.setRecords(service.readAll());
		return userListDto;
	}
